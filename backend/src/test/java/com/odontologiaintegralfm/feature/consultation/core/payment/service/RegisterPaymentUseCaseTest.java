...
class RegisterPaymentUseCaseTest {
    ...
    void execute_validPayment_persistsPaymentAndDetail() {
        ...
        PaymentRequestDTO dto = new PaymentRequestDTO(1L, new BigDecimal("200"), PaymentMethods.CASH);
    ...
    void execute_zeroAmount_throwsBadRequest() {
        ...
        PaymentRequestDTO dto = new PaymentRequestDTO(1L, BigDecimal.ZERO, PaymentMethods.CASH);
    ...
    void execute_negativeAmount_throwsBadRequest() {
        ...
        PaymentRequestDTO dto = new PaymentRequestDTO(1L, new BigDecimal("-100"), PaymentMethods.CASH);
    ...
    void execute_amountExceedsRemainingDebt_throwsConflict() {
        ...
        PaymentRequestDTO dto = new PaymentRequestDTO(1L, new BigDecimal("300"), PaymentMethods.CASH);
    ...
    void execute_prestationNotFound_throwsNotFoundException() {
        ...
        PaymentRequestDTO dto = new PaymentRequestDTO(99L, new BigDecimal("100"), PaymentMethods.CASH);
