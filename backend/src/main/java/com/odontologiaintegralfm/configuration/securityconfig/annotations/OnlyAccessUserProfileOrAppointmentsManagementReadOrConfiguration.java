...
@PreAuthorize("" +
        ...
        "hasAuthority('PERMISO_CONFIGURATION_READ') or hasAuthority('PERMISO_APPOINTMENT_MANAGEMENT_READ')")
public @interface OnlyAccessUserProfileOrAppointmentsManagementReadOrConfiguration {
}
