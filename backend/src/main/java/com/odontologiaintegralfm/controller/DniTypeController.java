...
public class DniTypeController {
    ...
    /**
     * Endpoint para obtener todos los tipos de Identificación
     * <p>
    ...
    public ResponseEntity<Response<List<DniTypeResponseDTO>>> getAll(){
        Response<List<DniTypeResponseDTO>> response = dniTypeService.getAll();
