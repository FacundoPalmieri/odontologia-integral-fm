...
public class AppointmentConflictService{
    ...
    private final IAppointmentConflictRepository appointmentConflictRepository;
    private final MessageSource messageSource;

    public AppointmentConflictService(IAppointmentConflictRepository appointmentConflictRepository,
                                      MessageSource messageSource) {
        this.appointmentConflictRepository = appointmentConflictRepository;
    ...
    public Response<List<AppointmentConflictResponseDTO>> getConflictByDentistId(Long idDentist) {
        ...
        if ( appointmentConflicts == null || appointmentConflicts.isEmpty()) {
            String messageUser = messageSource.getMessage("appointmentConflictService.getConflict.empty", null, LocaleContextHolder.getLocale());
