...
@Service
public class DentistAvailabilityCreateUseCase implements IDentistAvailabilityCreateUseCase {
    ...
    public DentistAvailabilityCreateUseCase(
    ...
    private DentistAvailabilityContextInternalDTO prepareContext(Long dentistId){
        ...
        List<DentistAvailability> dentistAvailabilityExisting = dentistAvailabilityService.getByIdInternal(dentistId);
