...
@Service
public class DentistCalendarLockUpdateUseCase implements IDentistCalendarLockUpdateUseCase {
    ...
    public DentistCalendarLockUpdateUseCase(DentistCalendarLockService dentistCalendarLockService, MessageSource messageSource, IAppointmentConflictService appointmentConflictService, AuthenticatedUserService authenticatedUserService) {
