...
@Service
public class CreateDentistHolidayUseCase implements ICreateDentistHolidayUseCase {
    ...
    public CreateDentistHolidayUseCase(
    ...
    public Response<DentistHolidayResponseDTO> execute(Long userId, DentistHolidayRequestCreateDTO dto) {
        //Obtiene el usuario.
        UserSec userSec = userService.findById(userId);
        ...
        //Obtiene el feriado.
        Holiday holiday = holidayService.findById(dto.idHoliday());
