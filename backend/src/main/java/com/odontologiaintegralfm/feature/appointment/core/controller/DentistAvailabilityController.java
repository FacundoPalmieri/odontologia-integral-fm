...
public class DentistAvailabilityController {
     ...
     *
     * @param dentistAvailabilityRequestDTO DTO con los datos de disponibilidad.
     */
    ...
    public ResponseEntity<Response<DentistAvailabilityResponseDTO>> update(@Valid
                                                                           @RequestBody
                                                                           DentistAvailabilityRequestDTO dentistAvailabilityRequestDTO ) {

        Response<DentistAvailabilityResponseDTO> response  =  dentistAvailabilityService.update(dentistAvailabilityRequestDTO);
