...
import com.odontologiaintegralfm.feature.consultation.catalogs.service.TreatmentConditionService;
...
public class TreatmentConditionController {
    ...
    @Autowired
    private TreatmentConditionService treatmentConditionService;
