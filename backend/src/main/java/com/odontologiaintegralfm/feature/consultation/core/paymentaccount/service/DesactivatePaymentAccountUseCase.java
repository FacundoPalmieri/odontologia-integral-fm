...
public class DesactivatePaymentAccountUseCase {
    ...
    public Response<PaymentAccountDTOResponse> execute(Long idAccount) {
        ...
        if(!paymentAccount.getEnabled()){
            throw new ConflictException("exception.paymentAccount.disabled.user",null,"exception.paymentAccount.disabled.log", new Object[]{idAccount,"UpdatePaymentAccountUseCase", "disabled"}, LogLevel.ERROR);
        }
