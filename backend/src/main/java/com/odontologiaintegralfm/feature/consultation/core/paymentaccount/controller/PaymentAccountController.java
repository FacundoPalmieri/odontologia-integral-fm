package com.odontologiaintegralfm.feature.consultation.core.paymentaccount.controller;
...
import com.odontologiaintegralfm.feature.consultation.core.paymentaccount.dto.PaymentAccountDTORequest;
import com.odontologiaintegralfm.feature.consultation.core.paymentaccount.dto.PaymentAccountDTOResponse;
import com.odontologiaintegralfm.feature.consultation.core.paymentaccount.service.*;
...
public class PaymentAccountController {
    ...
    public PaymentAccountController(CreatePaymentAccountUseCase createPaymentAccountUseCase,
        ...
        this.updatePaymentAccountUseCase = updatePaymentAccountUseCase;
    ...
    public ResponseEntity<Response<PaymentAccountDTOResponse>> update (@PathVariable Long id,
        ...
        Response<PaymentAccountDTOResponse> response = updatePaymentAccountUseCase.execute(id, paymentAccountDTORequest);
        return new ResponseEntity<>(response, HttpStatus.CREATED);
    }
