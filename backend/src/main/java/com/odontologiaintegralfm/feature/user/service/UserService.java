...
import com.odontologiaintegralfm.feature.authentication.service.implement.RoleService;
...
public class UserService implements IUserService {
     ...
     */
    public boolean verifyAttempts(String username){
        try{
     ...
     */
    @Transactional
    public UserSec blockAccount(String username){
