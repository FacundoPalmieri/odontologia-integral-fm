import {
  ...
  DentistDayAvailabilityDto,
} from "../dtos/dentist-availability.dto";
import {
  DentistDayAvailabilityInterface,
  TimeInterface,
} from "../interfaces/dentist-availability.interface";
...
export class DentistAvailabilitySerializer {
   ...
   */
  static toView(
    dto: DentistAvailabilityDto | any,
  ): DentistDayAvailabilityInterface[] {
    ...
    return daysArray.map((dayDto: DentistDayAvailabilityDto) => {
