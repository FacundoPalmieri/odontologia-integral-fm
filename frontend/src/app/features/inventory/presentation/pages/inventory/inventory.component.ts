...
export class InventoryComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  insumosDataSource = new MatTableDataSource<InventoryDto>([]);
  ...
  editInsumo(insumo: InventoryDto) {
  ...
  private _loadInsumos(
    ...
    this.inventoryService
      ...
      .subscribe(
        (
          response: ApiResponseInterface<PagedDataInterface<InventoryDto[]>>,
        ) => {
